...
public class ProductControllerTest {
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.dataList", hasSize(5)))
                .andExpect(jsonPath("$.dataList[0].productId", equalTo(6)))
                .andExpect(jsonPath("$.dataList[1].productId", equalTo(5)))
                .andExpect(jsonPath("$.dataList[2].productId", equalTo(7)))
                .andExpect(jsonPath("$.dataList[3].productId", equalTo(4)))
                .andExpect(jsonPath("$.dataList[4].productId", equalTo(2)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.dataList", hasSize(2)))
                .andExpect(jsonPath("$.dataList[0].productId", equalTo(5)))
                .andExpect(jsonPath("$.dataList[1].productId", equalTo(4)));
    }
}